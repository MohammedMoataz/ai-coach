...
1. **Detect.** Check what exists — `docs/onboarding/*`, `CLAUDE.md`, `CONTRIBUTING`, `README`,
   ...
   A generated file carries `> Generated by /investigation-coach:onboard · <date>` at the top;
...
docs/onboarding/
  ...
  start-here.md    setup to first run · a suggested first task · core flows · glossary ·
                   how-we-work · who-to-ask · pointer to the native /team-onboarding
...
5. **Remember.** After a verified write:
